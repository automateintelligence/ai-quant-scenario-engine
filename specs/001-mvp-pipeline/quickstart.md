...
- Generate partitions: `python -m backtesting.cli.fetch --symbol AAPL --start 2018-01-01 --end 2024-12-31 --interval 1d --target data/`
    ...
    - name: call_basic
      ...
      shared:
        option_spec:
          ...
          contracts: 1
  ```
- Run: `python -m backtesting.cli.grid --config configs/grid_aapl.yaml`
...
- Commands assume `backtesting` import path is installed (editable): `pip install -e .`.
- CLI names map to Typer entrypoints under `backtesting/cli`.
...
- Script sketch:
  ...
  python3 -m venv .venv \
    ...
    && python -m backtesting.cli.fetch --symbol AAPL --start 2018-01-01 --end 2024-12-31 --interval 1d --target data/
  ```
